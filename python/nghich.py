...
# Change the current working directory to ksdk_path.
    os.chdir(ksdk_path)
        ...
        for file_name in files:
            ...
            if file_name.count('123'):
                ...
                if file_name.count(old_name):
                    #noi root va file_name
                    file_path = os.path.join(root, file_name)

                    # tra ve duong dan chinh xac cua path
                    old_file_path = os.path.abspath(file_path)

                    # tra ve duong dan chinh xac cua thu muc gan nhat chua no giong nhu ../
